    ...
    <AceterityAurora className="min-h-screen" showRadialGradient={true}>
      ...
      >
        ...
        >
          ...
          <span className="text-sm text-primary">AI-Powered Chatbots</span>
        </motion.div>
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.9]">
            <span className="block text-foreground">Instant Replies</span>
            <span className="block bg-gradient-to-r from-primary via-orange-400 to-emerald-500 bg-clip-text text-transparent">
              Every Channel
            </span>
          </h1>
        </motion.div>
        ...
        >
          We build AI chatbots that handle customer DMs, qualify leads, answer FAQs, and provide 24/7 support
          — across every messaging channel your business uses.
        </motion.p>
