...
export function GHLHeroSection() {
    ...
    <AceterityAurora className="min-h-screen" showRadialGradient={true}>
      ...
      >
        ...
        >
          ...
          <span className="text-sm text-primary">Go High Level Automation</span>
        </motion.div>
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.9]">
            <span className="block text-foreground">Close More</span>
        ...
        >
          We set up and automate Go High Level for your business — from lead capture and nurturing to appointment
          booking, sales pipelines, and reputation management. All on autopilot.
        </motion.p>
        ...
        >
          {[
            { value: "All-in-One", label: "CRM & Marketing" },
            { value: "Full", label: "Setup & Configuration" },
            { value: "Ongoing", label: "Support Available" },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
              initial={{ opacity: 0, scale: 0.8 }}
