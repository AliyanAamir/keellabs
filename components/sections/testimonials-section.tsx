...
const testimonials = [
  ...
  {
    quote:
      "Our Go High Level setup was a mess before Keellabs stepped in. They rebuilt our pipelines, automated all our follow-up sequences, and our appointment show rate jumped from 40% to 72% in the first month.",
    author: "Priya Nair",
    role: "Founder",
