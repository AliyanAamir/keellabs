    ...
    <AceterityAurora className="min-h-screen" showRadialGradient={true}>
      ...
      >
        ...
        >
          ...
          <span className="text-sm text-primary">Social Media Automation</span>
        </motion.div>
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.9]">
            ...
            <span className="block bg-gradient-to-r from-primary via-orange-400 to-pink-500 bg-clip-text text-transparent">
              Posts Itself
            </span>
          </h1>
        </motion.div>
        ...
        >
          We build AI-powered social media content engines that create, schedule, and post across all your platforms
          — consistent brand voice, zero manual work.
        </motion.p>
